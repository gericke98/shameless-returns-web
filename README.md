...
| `TRACKING_EMAILS_ENABLED` | Set to `true` to let the daily tracking cron actually email customers. Anything else (including unset) makes it a dry run that logs what it would have sent. |
